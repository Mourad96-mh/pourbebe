        ...
        <div className={styles.brand}>
          ...
          <div className={styles.socials}>
            ...
            <div className={styles.socialIcons}>
              <a href="https://www.facebook.com/pourbebes/" target="_blank" rel="noreferrer" className={styles.socialBtn} aria-label="Facebook">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/pour.bebes" target="_blank" rel="noreferrer" className={styles.socialBtn} aria-label="Instagram">
